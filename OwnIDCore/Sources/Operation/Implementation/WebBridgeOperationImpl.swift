...
internal final class WebBridgeOperationImpl: WebBridgeOperation, @unchecked Sendable {
    ...
    internal func start(params: WebBridgeOperationParams? = nil) -> any OperationController<Void, WebBridgeOperationFailure> {
        enqueueStart(params: params)
        return controller
    }

    @discardableResult
    internal func startWebBridge(params: WebBridgeOperationParams? = nil) -> any WebBridgeOperationController {
        enqueueStart(params: params)
        return controller
    }

    private func enqueueStart(params: WebBridgeOperationParams?) {
        let stream = self.stream
        taskScope.spawn { [stream] in
...
private final class Failed: WebBridgeOperation, @unchecked Sendable {
    ...
    @discardableResult
    func startWebBridge(params: WebBridgeOperationParams? = nil) -> any WebBridgeOperationController {
        controllerImpl
    }
