...
/// complete or cancel. Releasing or clearing the controller reference only loses the app's handle; it does not cancel
/// the server challenge. Call ``cancel(reason:)`` before clearing the last reference when the app abandons this
/// challenge.
///
