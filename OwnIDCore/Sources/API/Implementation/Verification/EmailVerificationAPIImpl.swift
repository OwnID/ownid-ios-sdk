...
internal final class EmailVerificationAPIImpl: EmailVerificationAPI {
    ...
    ) async -> APIResult<any EmailVerificationAPIController, EmailVerificationStartAPIFailure> {
        do {
            ...
            let request = try EmailVerificationStartAPICall(
                apiBaseURL: baseUrl,
                coder: coder,
                loginID: loginID,
    ...
    internal static func create(resolver: any DIContainerResolver) -> any EmailVerificationAPI {
        do {
            return EmailVerificationAPIImpl(
...
private final class Failed: EmailVerificationAPI, @unchecked Sendable {
