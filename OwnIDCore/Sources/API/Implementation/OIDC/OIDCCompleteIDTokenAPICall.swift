...
internal final class OIDCCompleteIDTokenAPICall: APICall {
    ...
    internal init(
        ...
        var request = NetworkRequest(
            url: apiBaseURL.appendingPathComponent("oidc/idp/complete")
        )

        let requestBody = InternalCompleteOidcChallengeRequest(challengeId: InternalChallengeId(challengeID.value), idToken: idToken)
