...
internal final class EmailEnrollAPIImpl: EmailEnrollAPI {
    ...
    internal func start(params: EmailEnrollAPIParams) async -> APIResult<Void, EmailEnrollAPIFailure> {
        do {
            ...
            let request = try EmailEnrollAPICall(
    ...
    internal static func create(resolver: any DIContainerResolver) -> any EmailEnrollAPI {
        do {
            return EmailEnrollAPIImpl(
...
private final class Failed: EmailEnrollAPI, @unchecked Sendable {
