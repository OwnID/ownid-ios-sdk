...
internal final class PasskeyEnrollAPIImpl: PasskeyEnrollAPI {
    ...
    internal func start(params: PasskeyEnrollAPIParams) async -> APIResult<Void, PasskeyEnrollAPIFailure> {
        do {
            ...
            let request = try PasskeyEnrollAPICall(
    ...
    internal static func create(resolver: any DIContainerResolver) -> any PasskeyEnrollAPI {
        do {
            return PasskeyEnrollAPIImpl(
...
private final class Failed: PasskeyEnrollAPI, @unchecked Sendable {
