...
internal final class LoginAPIImpl: LoginAPI {
    ...
    internal func start(params: LoginAPIParams?) async -> APIResult<LoginResponse, LoginAPIFailure> {
        do {
    ...
    internal static func create(resolver: any DIContainerResolver) -> any LoginAPI {
        do {
            return LoginAPIImpl(
...
private final class Failed: LoginAPI, @unchecked Sendable {
