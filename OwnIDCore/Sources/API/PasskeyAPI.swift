...
///
/// Keep the controller strongly referenced while the challenge can still verify or cancel. Releasing or clearing the
/// controller reference only loses the app's handle; it does not cancel the server challenge. Call
