...
struct LoginIDContextContractTests {
    ...
    @Test(arguments: LoginIDDescriptionExpectation.allCases)
    func `Login ID descriptions mask email phone and other IDs by type`(_ expectation: LoginIDDescriptionExpectation) {
        #expect(expectation.loginID.description == expectation.expectedDescription)
    }
...
struct LoginIDDescriptionExpectation: Sendable, CustomTestStringConvertible {
    let loginID: LoginID
    ...
    static let allCases = [
        ...
        LoginIDDescriptionExpectation(
            ...
            expectedDescription: "LoginID(id: 'not-an-email', type: email)",
        ...
        LoginIDDescriptionExpectation(
            ...
            expectedDescription: "LoginID(id: '555-1234', type: phoneNumber)",
            testDescription: "invalid phone is unchanged"
        ),
        LoginIDDescriptionExpectation(
            loginID: LoginID(id: "  person-id  ", type: .userName),
            expectedDescription: "LoginID(id: 'pe\(String(repeating: "\u{2022}", count: 5))id', type: userName)",
            testDescription: "username is masked"
        ),
    ]
}
