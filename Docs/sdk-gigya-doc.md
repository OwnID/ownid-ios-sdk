...
[Complete example](https://github.com/OwnID/ios-sdk/blob/master/Demo/GigyaDemo/Configs/Example/OwnIDConfiguration.plist)
```xml
...
[Complete example](https://github.com/OwnID/ios-sdk/blob/master/Demo/GigyaDemo/App/GigyaLogin.swift)
```swift
...
[Complete example](https://github.com/OwnID/ios-sdk/blob/master/Demo/GigyaDemo/App/DemoApp.swift)
```swift
@main
...
If you did not follow the recommendation for creating the `OwnIDConfiguration.plist` file, you need to specify arguments when calling the `configure` function. For details, see [Alternative Syntax for Configure Function](https://github.com/OwnID/ios-sdk/blob/master/Docs/sdk-gigya-doc.md#alternative-syntax-for-configure-function-).
...
### Add OwnID WebView Bridge
 ...
 See [complete example](https://github.com/OwnID/ios-sdk/blob/master/Demo/ScreensetsDemo/DemoApp.swift)

 ```swift
 struct DemoApp: App {
    init() {
        OwnID.GigyaSDK.configure(appID: "...", environment: "dev")
...
[Complete example](https://github.com/OwnID/ios-sdk/blob/master/Demo/GigyaDemo/App/GigyaRegister.swift)
```swift
...
[Complete example](https://github.com/OwnID/ios-sdk/blob/master/ownid-core-ios-sdk/Core/Sources/Types/CoreError.swift)
```swift
switch error {
