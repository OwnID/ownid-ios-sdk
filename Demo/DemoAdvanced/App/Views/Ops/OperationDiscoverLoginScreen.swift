...
struct OperationDiscoverLoginScreen: View {
    ...
    var body: some View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Button("Start Discover Operation") {
                    viewModel.startDiscoverOperation()
                }
                .buttonStyle(PrimaryButtonStyle())
                .frame(maxWidth: .infinity, alignment: .center)
                .disabled(!viewModel.screenState.canStartDiscoverOperation)

                if viewModel.screenState.accessToken == nil {
                    Text("Access token required for Login operation")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .center)
                ...
                Button("Start Login Operation") {
                    viewModel.startLoginOperation()
                }
                .buttonStyle(PrimaryButtonStyle())
                .frame(maxWidth: .infinity, alignment: .center)
                .disabled(viewModel.screenState.accessToken == nil)
        ...
        .navigationTitle("Operations / Discover and Login")
