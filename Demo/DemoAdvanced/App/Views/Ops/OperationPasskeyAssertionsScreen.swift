...
struct OperationPasskeyAssertionsScreen: View {
    ...
    var body: some View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Button("Start Passkey Assertion Operation") {
                    viewModel.startPasskeyAssertionOperation()
                }
        ...
        .navigationTitle("Operations / Passkey Assertions")
