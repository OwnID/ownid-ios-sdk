    ...
    func startLoginIdCollectOperation() {
        Task { @MainActor [weak self] in
            ...
            case .dialog, .embedded:
                let controller = loginIDCollectOperation.appHostedComponent.start()
        ...
        Task { @MainActor [weak self] in
            ...
            case .email:
                ...
                if uiMode == .default {
                    ...
                    let controller = operations.verifications.email.appHostedComponent.start()
            ...
            case .phoneNumber:
                ...
                if uiMode == .default {
                    ...
                    let controller = operations.verifications.phone.appHostedComponent.start()
