...
internal struct PhoneVerificationUIDefaultProvider: PhoneVerificationUIProvider, Sendable {
    @MainActor
...
internal struct PhoneVerificationDefaultView: View {
    private let uiState: PhoneVerificationUIState
    private let uiStrings: PhoneVerificationStrings
