...
extension OwnID.UISDK {
    struct AxisTooltip<B, F>: ViewModifier where B: View, F: View {
...
extension OwnID.UISDK.AxisTooltip where B == EmptyView, F : View {
...
extension OwnID.UISDK.AxisTooltip where B : View, F : View {
