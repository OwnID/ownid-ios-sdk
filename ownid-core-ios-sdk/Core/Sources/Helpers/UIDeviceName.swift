...
extension UIDevice {
    ...
    static var modelName: String {
        ...
        let deviceName = mapToDevice(identifier: identifier)
        return deviceName
    }
    ...
    static func mapToDevice(identifier: String) -> String {
        ...
        case "iPad14,3", "iPad14,4":                          return "iPad Pro (11-inch) (4rd generation)"
    ...
    static func simulatorName(identifier: String) -> String {
